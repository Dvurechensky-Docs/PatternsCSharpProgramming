 ...
 * Last Updated: 15 сентября 2025 06:51:57
 * Version: 1.0.29
 */
 ...
 *   
    Важные уточнения
        ...
        SRP не запрещает один класс использовать другие классы — наоборот, именно через делегирование достигается чистота ответственности.

        SRP работает на уровне причин изменения, а не просто функций. Т.е. важно думать, почему может измениться код.
